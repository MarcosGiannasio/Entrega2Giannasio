...
if (tipoDeco == "particular" && tipoAmbiente== "interior"){
          ...
          var cotizAlt = Number(prompt("Ingresá solo en números la altura de tu/s ambiente/s"));
          var cotizYear = Number(prompt("Ingresá solo en números los años de antiguedad "));
